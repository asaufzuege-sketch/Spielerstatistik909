...
<body>
  ...
  <!-- SPIELERAUSWAHL -->
  <div id="playerSelectionPage" class="page">
  ...
  <div id="statsPage" class="page" style="display:none;">
    <!-- ZENTRIERTE TOOLBAR ÜBER TABELLE -->
    <div class="page-toolbar" id="statsToolbar">
      <div class="top-bar">
  ...
  <div id="torbildPage" class="page" style="display:none;">
    <!-- ZENTRIERTE TOOLBAR ÜBER BILDER -->
    <div class="page-toolbar" id="torbildToolbar">
      <div class="top-bar">
        ...
        <div class="time-tracking-box" id="timeTrackingBox">
          <div class="period" data-period="p1">
            ...
            <div class="period-buttons top-row">
              <button class="time-btn">0</button>
              <button class="time-btn">0</button>
              <button class="time-btn">0</button>
              <button class="time-btn">0</button>
            </div>
            <div class="period-numbers">
              <span class=" num-center">19 - 15</span>
              <span class="num-center">14 - 10</span>
              <span class="num-center">9 - 5</span>
              <span class="num-center">4 - 0</span>
            </div>
  ...
  <div id="goalValuePage" class="page" style="display:none;">
    <div class="page-toolbar" id="goalValueToolbar">
      <div class="top-bar">
  ...
  <div id="seasonMapPage" class="page" style="display:none;">
    <div class="page-toolbar" id="seasonMapToolbar">
      <div class="top-bar">
    ...
    <div class="torbild-layout">
      ...
      <div class="goal-column">
        ...
        <div class="time-tracking-box" id="seasonTimeTrackingBox">
